  ...
  static List<dynamic> getDefaultMedicines() {
    return [
      ...
      Tablet(
        ...
        instructions: 'Take after meals. Do not exceed 1200mg per day',
        shape: 'Oval',
        color: 'Yellow',
        coated: false,
      ),
      ...
      Injection(
        ...
        instructions: 'Inject subcutaneously at the same time each day, preferably before bedtime',
      ...
      Syrup(
        ...
        instructions: 'Shake well before use. Take after meals',
        flavor: 'Cherry',
        volumeMl: 100.0,
        sugarFree: false,
      ),
